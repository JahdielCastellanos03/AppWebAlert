...
-- =====================================================
-- TABLAS PARA SISTEMA DE ESCALAS DE VALORES Y RANGOS
-- =====================================================

-- Tabla para almacenar las escalas de valores
DROP TABLE IF EXISTS `dashboard_escala_de_valores`;
CREATE TABLE `dashboard_escala_de_valores` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_general_ci,
  `sensor` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `fecha_creacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `esta_habilitada` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `idx_sensor` (`sensor`),
  KEY `idx_habilitada` (`esta_habilitada`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Tabla para almacenar los rangos de valores dentro de cada escala
DROP TABLE IF EXISTS `dashboard_rangos`;
CREATE TABLE `dashboard_rangos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_general_ci,
  `valor_minimo` decimal(10,2) NOT NULL,
  `valor_maximo` decimal(10,2) NOT NULL,
  `color` varchar(7) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '#FF0000',
  `escala_id` int NOT NULL,
  `fecha_creacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `esta_habilitado` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `idx_escala_id` (`escala_id`),
  KEY `idx_valores` (`valor_minimo`, `valor_maximo`),
  KEY `idx_habilitado` (`esta_habilitado`),
  CONSTRAINT `fk_rangos_escala` FOREIGN KEY (`escala_id`) REFERENCES `dashboard_escala_de_valores` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- =====================================================
-- FIN DE TABLAS PARA SISTEMA DE ESCALAS Y RANGOS
-- =====================================================
